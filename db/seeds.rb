...
Port.find_or_create_by(name: "Sean1_IN",      io: true,  path: "system:capture_5",   port_group: PortGroup.find_by(name: "Sean",     io: true))
Port.find_or_create_by(name: "Sean2_IN",      io: true,  path: "system:capture_6",   port_group: PortGroup.find_by(name: "Sean",     io: true))
...
Port.find_or_create_by(name: "Guit1_IN",      io: true,  path: "hipbox:guit1",       port_group: PortGroup.find_by(name: "James",    io: true))
Port.find_or_create_by(name: "Guit2_IN",      io: true,  path: "hipbox:guit2",       port_group: PortGroup.find_by(name: "Jesse",    io: true))
Port.find_or_create_by(name: "Bass_IN",       io: true,  path: "hipbox:bass",        port_group: PortGroup.find_by(name: "Mitch",    io: true))
Port.find_or_create_by(name: "Drums_IN",      io: true,  path: "hipbox:drums",       port_group: PortGroup.find_by(name: "Sean",     io: true))
Port.find_or_create_by(name: "Aux_IN",        io: true,  path: "hipbox:aux")
