...
Variable.create([
  { name: 'mitch_fx_locut',     status: false },
  { name: 'mitch_fx_hicut',     status: false },
  { name: 'mitch_fx_dist',      status: false },
  { name: 'mitch_fx_delay',     status: false },
  { name: 'mitch_fx_reverb',    status: false },
