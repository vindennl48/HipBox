...
class NetworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post networks_url, params: { network: { default: @network.default, name: @network.name, password: @network.password } }
    end
  ...
  test "should update network" do
    patch network_url(@network), params: { network: { default: @network.default, name: @network.name, password: @network.password } }
